...
const DepositPage = () => {
  ...
  return (
    <div className="min-h-screen flex flex-col sm:flex-row justify-center items-center gap-32">
      <div className="min-h-screen flex items-center justify-center px-4 text-black">
        <div className="w-full min-w-md">
          <div className="bg-white rounded-lg shadow-lg overflow-hidden">
            ...
            <form className="p-6 space-y-4" onSubmit={handleDeposit}>
      ...
      <SQLPreview
        sqlText={`UPDATE accounts SET balance = balance + ${amount || 'Amount'} WHERE account_number = '${selectedAccount || 'AccountNumber'}' AND pin = '${pin || 'Pin'}';`}
      />
    </div>
  );
};
